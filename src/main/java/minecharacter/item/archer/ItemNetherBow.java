...
public class ItemNetherBow extends ItemArcherBow {
	...
	public void registerIcons(IconRegister par1IconRegister) {
		this.itemIcon=par1IconRegister.registerIcon("minecharacter:"+netherBowPullIconNameArray[0]);
		 this.iconArray = new Icon[netherBowPullIconNameArray.length];

		    for (int i = 0; i < this.iconArray.length; ++i)
		    {
		        this.iconArray[i] = par1IconRegister.registerIcon("minecharacter:"+netherBowPullIconNameArray[i]);
		    }
	}
