...
public class ItemBeer extends CharItemFood {
	public ItemBeer(int par2, float par3, boolean par4) {
	...
	public ItemStack onEaten(ItemStack par1ItemStack, World par2World,
		...
		par3EntityPlayer.getFoodStats().addStats(
				this.func_150905_g(par1ItemStack),
				this.func_150906_h(par1ItemStack));
		par2World.playSoundAtEntity(par3EntityPlayer, "random.burp", 0.5F,
				par2World.rand.nextFloat() * 0.1F + 0.9F);
		this.onFoodEaten(par1ItemStack, par2World, par3EntityPlayer);

		return par1ItemStack.stackSize <= 0 ? new ItemStack(Items.glass_bottle)
				: par1ItemStack;
	}
