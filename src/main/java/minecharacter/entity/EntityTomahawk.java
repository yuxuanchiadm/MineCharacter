...
public class EntityTomahawk extends Entity implements IThrowableEntity,IProjectile {
...
private int itemDamage;
    ...
    public EntityTomahawk(World par1World, ItemStack itemstack,EntityLivingBase par2EntityLiving, float par3)
    {
        super(par1World);
...
//                    }
                    ...
                    if (movingobjectposition.entityHit.attackEntityFrom(damagesource, i1))
                    {
                        if (movingobjectposition.entityHit instanceof EntityLiving)
                        {
                            ...
                            if (this.thrower != null)
                            {
                                EnchantmentThorns.func_92096_a(this.thrower, entityliving, this.rand);
                            }

                            if (this.thrower != null && movingobjectposition.entityHit != this.thrower && movingobjectposition.entityHit instanceof EntityPlayer && this.thrower instanceof EntityPlayerMP)
                            {
                                ((EntityPlayerMP)this.thrower).playerNetServerHandler.sendPacketToPlayer(new Packet70GameEvent(6, 0));
                            }
                        }
...
//            }
	...
	public void onCollideWithPlayer(EntityPlayer par1EntityPlayer) {
		   if (FMLCommonHandler.instance().getEffectiveSide()==Side.CLIENT){
				...
				{
					PacketSpawnItem.spawnItem(InitItem.tomahawk.itemID, this.itemDamage,1, xTile, yTile, zTile);
					this.setDead();
				}
		   }
